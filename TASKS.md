...
- [ ] 운영 daemon 에서 weather-now 1.1.0 reinstall
...
- [ ] **Telegram Pair Code** — `FetchTelegramChatID` 의 daemon race + multi-user 신원 탈취. Kakao pair-code 패턴 이식 예정. account==user 모델 확정 후 재검토 가치 있음.
...
### Plan 25 — Family Multi-Account (macOS single daemon, 7 personal + 1 family)
